...
public record RestoreCommentCommand : IRequest<Result>
{
...
public class RestoreCommentCommandHandler : IRequestHandler<RestoreCommentCommand, Result>
{
                               ...
                               CancellationToken cancellationToken)
    {
        ...
        if (comment.IsActive)
        {
            return Result.Failure(CommentError.AlreadyActive);
        }
        ...
        var update = Builders<Recipe>.Update.Set("Comments.$.IsActive", true);
