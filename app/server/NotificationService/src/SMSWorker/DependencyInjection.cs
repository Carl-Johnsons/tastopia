...
{
    public static IServiceCollection AddWorkerServices(this IServiceCollection services, string serviceName = "SMSWorker")
    {
    ...
    private static IServiceCollection AddMassTransitService(this IServiceCollection services)
    {
        services.AddMassTransit(busConfig =>
        {
            ...
            var applicationAssembly = AppDomain.CurrentDomain.Load("SMSWorker");
