...
public class RecipeData
{
    ...
    public static List<Recipe> Recipes = [
        ...
        new Recipe {
            ...
            Description = "A simple dish highlighting the robust flavor of king trumpet mushrooms sautéed with garlic and herbs.",
            ...
            Steps = [
                new Step {
                    Content = "Clean and slice the mushrooms.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Heat olive oil in a pan and sauté minced garlic until fragrant.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add mushrooms and cook until tender.",
                    OrdinalNumber = 3
                },
                new Step {
        ...
        new Recipe {
            ...
            Description = "A creamy risotto featuring king trumpet mushrooms for a savory and satisfying meal.",
            ImageUrl = "https://lifesourcenaturalfoods.com/wp-content/uploads/2022/04/Risotto_TrumpetMushroom-0154_530x350.jpg",
            Serves = 4,
            CookTime = "30m",
            Ingredients = [
                "250g King Trumpet Mushrooms",
                "1 cup Arborio Rice",
                "1/2 cup White Wine",
            ...
            Steps = [
                new Step {
                    Content = "Sauté chopped onion in butter until translucent.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Add sliced mushrooms and cook until soft.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Stir in rice and toast for 2 minutes.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Gradually add broth and wine, stirring constantly until creamy.",
                    OrdinalNumber = 4
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
                    OrdinalNumber = 5
                }
            ]
        },
        new Recipe {
            ...
            Description = "A quick stir-fry with shiitake mushrooms and vegetables, perfect for a healthy meal.",
            ImageUrl = "https://cleananddelicious.com/wp-content/uploads/2021/08/shiitake-mushrooms-recipe-1.jpg",
            Serves = 3,
            CookTime = "20m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Slice shiitake mushrooms and bell pepper.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Heat sesame oil in a wok; add garlic and ginger.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add mushrooms and bell pepper, stir-frying for 5 minutes.",
                    OrdinalNumber = 3
                },
                new Step {
        ...
        new Recipe {
            ...
            Description = "A warming soup featuring shiitake mushrooms and aromatic herbs.",
            ImageUrl = "https://www.simplyrecipes.com/thmb/rXAU4tiQSHzaDWJc0M1OBKzCyDE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2012__01__chicken-soup-ginger-shiitake-horiz-a-1600-313805e44a124afe87bd2a7a8c7977b2.jpg",
            Serves = 4,
            CookTime = "25m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Sauté chopped onion and garlic until softened.",
                    OrdinalNumber = 1
                },
                new Step {
                ...
                new Step {
                    Content = "Pour in chicken broth and soy sauce; simmer for 15 minutes.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
        ...
        new Recipe {
            ...
            Description = "Crispy tempura featuring delicate enoki mushrooms served with a light dipping sauce.",
            ImageUrl = "https://images.food52.com/BcnVFMvgVxyF1yW5hEGSNhovXiM=/1200x1200/10381dc8-9505-45c8-a7d0-fa3de6734885--yi-jun-loh-enoki-mushrooms.jpg",
            Serves = 2,
            CookTime = "20m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Prepare the tempura batter according to package instructions.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Dip enoki mushrooms into the batter.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Deep fry in hot oil until golden and crispy.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Drain on paper towels and sprinkle with salt.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "A refreshing salad with enoki mushrooms and mixed greens dressed in a light vinaigrette.",
            ImageUrl = "https://kirrconcept.com/cdn/shop/articles/IMG_9828.jpg?v=1629862239",
            Serves = 2,
            CookTime = "10m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Clean enoki mushrooms and trim the ends.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Combine mushrooms with mixed greens in a bowl.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Drizzle olive oil and lemon juice, then toss to combine.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Season with salt and pepper.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "A tangy and refreshing salad featuring crisp black fungus.",
            ImageUrl = "https://images.squarespace-cdn.com/content/v1/5b4f41e196e76f286102ccf0/1554816525020-QI2JAMREEOJJHFZ59F4D/IMG_9783.jpg",
            Serves = 2,
            CookTime = "15m",
            Ingredients = [
                "150g Black Fungus",
            ...
            Steps = [
                new Step {
                    Content = "Soak black fungus in warm water until softened, then drain.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Slice cucumber into thin julienne strips.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Toss black fungus and cucumber with rice vinegar, sugar, and salt.",
                    OrdinalNumber = 3
                }
            ]
        },
        new Recipe {
            ...
            Description = "A quick stir-fry combining black fungus with colorful vegetables.",
            ImageUrl = "https://img-global.cpcdn.com/recipes/ba0fe90072e4379c/680x482cq70/stir-fried-black-fungus-pork-egg-recipe-main-photo.jpg",
            Serves = 3,
            CookTime = "20m",
            Ingredients = [
                "150g Black Fungus, soaked and sliced",
                "1 Carrot, julienned",
            ...
            Steps = [
                new Step {
                    Content = "Prepare black fungus by soaking and slicing it.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Julienne the carrot and slice the bell pepper.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Stir-fry all ingredients in sesame oil over high heat.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Add soy sauce and season with salt and pepper.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Tender flower snails sautéed in garlic butter—a delicacy for seafood lovers.",
            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNSO09cA-W6VK52vSsKlYvvv9DLt56WzRI2Q&s",
            Serves = 2,
            CookTime = "15m",
            Ingredients = [
                "200g Flower Snails",
            ...
            Steps = [
                new Step {
                    Content = "Clean the flower snails thoroughly.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Melt butter in a pan and sauté minced garlic until fragrant.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add flower snails and cook until heated through.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Drizzle with lemon juice and season with salt and pepper.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "A hearty stew with flower snails simmered in a spicy tomato-based sauce.",
            ImageUrl = "https://homemadeinhk.wordpress.com/wp-content/uploads/2014/01/photo-3-54.jpg",
            Serves = 3,
            CookTime = "40m",
            Ingredients = [
                "250g Flower Snails",
            ...
            Steps = [
                new Step {
                    Content = "Sauté chopped onion and garlic until soft.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Add flower snails and cook for 5 minutes.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Pour in diced tomatoes and add chili flakes.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Simmer for 25 minutes and season with salt and pepper.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Colorful bell peppers stuffed with a savory mix of rice, meat, and vegetables.",
            ImageUrl = "https://tyberrymuch.com/wp-content/uploads/2020/09/vegan-stuffed-peppers-recipe-735x735.jpg",
            Serves = 4,
            CookTime = "35m",
            Ingredients = [
            ...
            Steps = [
                ...
                new Step {
                    Content = "Hollow out bell peppers.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Mix cooked rice, ground beef, onion, and tomato.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Stuff peppers with the mixture and bake for 25 minutes.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Sizzling bell pepper fajitas with onions and marinated chicken—perfect for a quick dinner.",
            ImageUrl = "https://www.foodandwine.com/thmb/PtpbKVWUpLOKmFRuDQbptohVrRM=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/201403-xl-chicken-fajitas-with-bell-peppers-77a7e7e8e4c34ef18f42b9c51144de76.jpg",
            Serves = 3,
            CookTime = "20m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Slice bell peppers and onion into strips.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Toss chicken with fajita seasoning.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Sauté chicken until nearly cooked, then add vegetables.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Cook for an additional 5 minutes until vegetables soften.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "A fragrant chicken soup infused with lemongrass and fresh herbs for a warming meal.",
            ImageUrl = "https://www.allrecipes.com/thmb/n5SFaJDeLLZOIVIt6GMRV_z5nak=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/4549752-e276cb4c148043458e61cacd14eb2f97.jpg",
            Serves = 4,
            CookTime = "30m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Bruise lemongrass and simmer in chicken broth.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Add chopped onion, garlic, and chicken thighs.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Simmer for 20 minutes until chicken is cooked.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
        ...
        new Recipe {
            ...
            Description = "Tender beef skewers marinated with lemongrass and grilled to perfection.",
            ImageUrl = "https://www.seriouseats.com/thmb/G5C2-Pr4m6ET_yEn7GumPe6H0WA=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/__opt__aboutcom__coeus__resources__content_migration__serious_eats__seriouseats.com__images__2015__06__20150530-shao-z-beef-skewers-4-be3e8f2aa59d40a9ab4f4c8b6e110bfb.jpg",
            Serves = 3,
            CookTime = "25m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Marinate beef with lemongrass, garlic, soy sauce, and olive oil.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Skewer the beef cubes and grill for 15 minutes.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
        ...
        new Recipe {
            ...
            Title = "BBQ Pork Ribs",
            Description = "Succulent pork ribs slathered in barbecue sauce and slow-cooked to perfection.",
            ...
            Steps = [
                new Step {
                    Content = "Preheat oven to 300°F.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Season pork ribs with salt, pepper, brown sugar, and paprika.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Coat ribs with BBQ sauce and bake for 2 hours.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Finish under the broiler for 5 minutes to caramelize the sauce.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Tender pork ribs slow cooked in a rich, savory sauce for an unforgettable flavor.",
            ImageUrl = "https://www.allrecipes.com/thmb/Yk6XPvsjJwPiq6Ed8UxejK0oKFE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/228498-slow-cooker-baby-back-ribs-DDMFS-008-4x3-052755bf2a444771918ef432757479a7.jpg",
            Serves = 4,
            CookTime = "3h",
            Ingredients = [
                "1kg Pork Ribs",
            ...
            Steps = [
                new Step {
                    Content = "Season pork ribs with salt, pepper, and garlic powder.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Combine tomato sauce and vinegar in a slow cooker.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add ribs and cook on low for 3 hours.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Serve with extra sauce drizzled on top.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Korean-style pork ribs with a spicy gochujang glaze, delivering a sweet, savory, and fiery kick.",
            ImageUrl = "https://www.souschef.co.uk/cdn/shop/articles/timthumb_34217f00-4032-414c-8807-b8389009f024.jpg?v=1531317210",
            Serves = 4,
            CookTime = "1h 30m",
            Ingredients = [
                "1kg Pork Ribs",
            ...
            Steps = [
                new Step {
                    Content = "Cut the pork ribs into individual pieces or smaller sections.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "In a bowl, whisk together gochujang, soy sauce, rice vinegar, honey, sesame oil, minced garlic, and grated ginger to create the marinade.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Marinate the ribs in the mixture for at least 30 minutes (or up to overnight in the refrigerator).",
                    OrdinalNumber = 3
                },
                new Step {
                ...
                new Step {
                    Content = "Arrange ribs on a baking sheet lined with parchment paper.",
                    OrdinalNumber = 5
                },
                new Step {
                    Content = "Bake for 45-60 minutes, basting with the marinade every 15 minutes, until ribs are cooked through and tender.",
                    OrdinalNumber = 6
                },
                new Step {
                    Content = "Optional: Finish under the broiler for a few minutes for extra char.",
                    OrdinalNumber = 7
                },
                new Step {
                    Content = "Garnish with sesame seeds and chopped green onions before serving.",
                    OrdinalNumber = 8
                }
            ]
        },
        new Recipe {
            ...
            Description = "Pork ribs coated in a sticky and sweet honey garlic glaze, baked until caramelized and delicious.",
            ImageUrl = "https://www.ontario.ca/foodland/_next/image?url=https%3A%2F%2Fwww.ontario.ca%2Ffiles%2Fs3fs-public%2Ffoodland%2F2024-09%2Fhoney-garlic-ribs.jpg&w=1200&q=75",
            Serves = 4,
            CookTime = "2h 15m",
            Ingredients = [
                "1kg Pork Ribs",
            ...
            Steps = [
                new Step {
                    Content = "Preheat oven to 325°F (160°C).",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Season pork ribs generously with salt and pepper.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Place ribs in a baking dish.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "In a small bowl, whisk together honey, soy sauce, minced garlic, rice vinegar, grated ginger, and red pepper flakes (if using).",
                    OrdinalNumber = 4
                },
                new Step {
                    Content = "Pour half of the honey garlic glaze over the ribs, ensuring they are well coated.",
                    OrdinalNumber = 5
                },
                new Step {
                    Content = "Cover the baking dish with foil and bake for 1.5 hours.",
                    OrdinalNumber = 6
                },
                new Step {
                    Content = "Remove foil, baste with the remaining glaze, and bake uncovered for another 30-45 minutes, or until ribs are tender and the glaze is caramelized.",
                    OrdinalNumber = 7
                },
                new Step {
                    Content = "Let rest for 10 minutes before serving.",
                    OrdinalNumber = 8
                }
            ]
        },
        new Recipe {
            ...
            ImageUrl = "https://www.allrecipes.com/thmb/mSWde3PHTu-fDkbvWBw0D1JlS8U=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/25202beef-stroganoff-iii-ddmfs-3x4-233-0f26fa477e9c446b970a32502468efc6.jpg",
            Serves = 4,
            CookTime = "35m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Sauté beef strips until browned.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Add onions and mushrooms; cook until softened.",
                    OrdinalNumber = 2
                },
                new Step {
                ...
                new Step {
                    Content = "Mix in sour cream and heat through.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Juicy beef steak grilled with a mix of fresh herbs for a flavorful meal.",
            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe_SrEHEh4hWd43bqPXvCDI9ziJNEfmWXZxQ&s",
            Serves = 2,
            CookTime = "20m",
            Ingredients = [
                "300g Beef Steak",
            ...
            Steps = [
                new Step {
                    Content = "Marinate steak with olive oil, garlic, rosemary, and thyme.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Grill steak to desired doneness.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Let rest for 5 minutes, then slice and serve.",
                    OrdinalNumber = 3
                }
            ]
        },
        new Recipe {
            ...
            Description = "Delicious dumplings filled with seasoned ground pork, perfect for dipping.",
            ImageUrl = "https://www.allrecipes.com/thmb/tCt2q6Sly6Spyu7fsM5c3Vxs8DI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/14759-pork-dumplings-DDMFS-4x3-f87c9459ec73475f9dcab4cc651c46d3.jpg",
            Serves = 4,
            CookTime = "40m",
            Ingredients = [
                "300g Ground Pork",
            ...
            Steps = [
                new Step {
                    Content = "Mix ground pork with shredded cabbage, garlic, and soy sauce.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Fill dumpling wrappers with the mixture and fold tightly.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Steam dumplings for 15 minutes.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Serve with your favorite dipping sauce.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "A hearty noodle dish tossed with spicy ground pork and crisp vegetables.",
            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTs6QeAYCdEUS8Mo7wrHP1L6nh7hRA65Wzrog&s",
            Serves = 3,
            CookTime = "30m",
            Ingredients = [
                "250g Ground Pork",
            ...
            Steps = [
                new Step {
                    Content = "Cook noodles according to package instructions.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Sauté ground pork with sliced onion and bell pepper until browned.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Mix in chili garlic sauce and soy sauce, then toss with noodles.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Serve hot.",
        ...
        new Recipe {
            ...
            Description = "Grilled chicken hearts marinated in a tangy sauce and skewered for an adventurous appetizer.",
            ImageUrl = "https://www.foodnetwork.com/content/dam/images/food/fullset/2021/10/25/YK504_Chicken-Heart-Yakitori-Skewers_s4x3.jpg",
            Serves = 3,
            CookTime = "25m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Clean and marinate chicken hearts with soy sauce, olive oil, and garlic.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Skewer the hearts evenly.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Grill for 15 minutes until charred and tender.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
        ...
        new Recipe {
            ...
            Description = "Tender chicken hearts quickly sautéed with fresh herbs—a unique and savory appetizer.",
            ImageUrl = "https://sandersonfarms.com/wp-content/uploads/2017/04/Recipes_Chicken_Hearts_with_Onions_and_Mushroom_Hero_824x758-720x.jpg",
            Serves = 2,
            CookTime = "20m",
            Ingredients = [
                "250g Chicken Hearts, trimmed",
                "1 tbsp Olive Oil",
                "1 Garlic Clove, minced",
                "1 tsp Thyme",
                "Pinch of Salt",
            ...
            Steps = [
                new Step {
                    Content = "Clean and slice chicken hearts.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Heat olive oil in a pan and sauté garlic until fragrant.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add chicken hearts and thyme; cook until tender.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Season with salt and pepper before serving.",
        ...
        new Recipe {
            ...
            Description = "A quick pasta dish tossed with garlic, succulent shrimp, and fresh herbs.",
            ImageUrl = "https://myeagereats.com/wp-content/uploads/2021/05/wp-1620987156623.jpg",
            Serves = 3,
            CookTime = "20m",
            Ingredients = [
                "250g Shrimp, peeled",
            ...
            Steps = [
                new Step {
                    Content = "Cook pasta until al dente and set aside.",
                    OrdinalNumber = 1
                },
                new Step {
                ...
                new Step {
                    Content = "Add shrimp and cook until they turn pink.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Toss pasta with shrimp, drizzle lemon juice, and season to taste.",
                    OrdinalNumber = 4
                }
            ]
        },
        new Recipe {
            ...
            Description = "Tacos filled with spicy shrimp, crisp slaw, and a zesty lime dressing.",
            ImageUrl = "https://bingeworthybites.com/wp-content/uploads/2020/01/Spicy-Shrimp-Tacos.jpg",
            Serves = 2,
            CookTime = "25m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Season shrimp with chili powder and salt.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Sauté shrimp in olive oil until cooked through.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Assemble tacos with shrimp, cabbage slaw, and a squeeze of lime.",
                    OrdinalNumber = 3
                }
            ]
        },
        new Recipe {
            ...
            Description = "Tender shrimp simmered in a fragrant and creamy coconut curry sauce, served with rice.",
            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTR4TVLeZEYZo0RM5p_Y9Z592ZJyVBFhzjMgg&s",
            Serves = 4,
            CookTime = "30m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Heat vegetable oil in a large pan or wok over medium-high heat.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Add chopped onion and sauté until softened, about 3 minutes.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Add minced garlic and grated ginger, and cook for another minute until fragrant.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Stir in the red curry paste and cook for 1 minute.",
                    OrdinalNumber = 4
                },
                new Step {
                ...
                new Step {
                    Content = "Pour in the coconut milk and vegetable broth. Bring to a simmer.",
                    OrdinalNumber = 6
                },
                new Step {
                    Content = "Stir in the fish sauce (or soy sauce) and brown sugar.",
                    OrdinalNumber = 7
                },
                new Step {
                    Content = "Add the shrimp and cook until they turn pink and are cooked through, about 3-5 minutes.",
                    OrdinalNumber = 8
                },
                new Step {
                    Content = "Stir in the lime juice.",
                    OrdinalNumber = 9
                },
                new Step {
                    Content = "Serve hot over cooked rice, garnished with fresh cilantro.",
                    OrdinalNumber = 10
                }
            ]
        },
        new Recipe {
            ...
            Description = "A lighter take on classic shrimp scampi, using zucchini noodles instead of pasta for a healthy and flavorful meal.",
            ImageUrl = "https://www.thespruceeats.com/thmb/qWmjcmUZxtRwve7YJRhUPzBjTt8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/zucchini-noodles-with-shrimp-scampi-4154511-c81b9cc83fcf467f867ee7d3e9af72c5.jpg",
            Serves = 2,
            CookTime = "20m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Spiralize the zucchinis into noodles. If you don't have a spiralizer, use a vegetable peeler to create long, thin ribbons.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Pat the zucchini noodles dry with paper towels to remove excess moisture. This will help them cook better.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Heat olive oil and butter in a large skillet over medium-high heat.",
                    OrdinalNumber = 3
                },
                new Step {
                    Content = "Add minced garlic and cook until fragrant, about 30 seconds. Don't let it burn.",
                    OrdinalNumber = 4
                },
                new Step {
                    Content = "Add the shrimp to the skillet and cook for 2-3 minutes per side, until pink and cooked through.",
                    OrdinalNumber = 5
                },
                new Step {
                    Content = "Pour in the white wine and let it simmer for a minute, allowing the alcohol to evaporate.",
                    OrdinalNumber = 6
                },
                new Step {
                    Content = "Add the zucchini noodles to the skillet and toss gently to coat them with the sauce. Cook for 2-3 minutes, until they are slightly softened but still have some bite.",
                    OrdinalNumber = 7
                },
                new Step {
                    Content = "Stir in the lemon juice, chopped parsley, and red pepper flakes (if using).",
                    OrdinalNumber = 8
                },
                new Step {
                    Content = "Season with salt and black pepper to taste.",
                    OrdinalNumber = 9
                },
                new Step {
                    Content = "Serve immediately.",
        ...
        new Recipe {
            ...
            Description = "Fresh lettuce leaves filled with a savory mix of vegetables and ground pork for a light meal.",
            ImageUrl = "https://cdn.apartmenttherapy.info/image/upload/v1715705702/k/Photo/Recipes/2024-05-chicken-lettuce-wraps/chicken-lettuce-wraps-315.jpg",
            Serves = 3,
            CookTime = "15m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Cook ground pork with diced carrot and bell pepper until browned.",
                    OrdinalNumber = 1
                },
                new Step {
                ...
                new Step {
                    Content = "Spoon the mixture into crisp lettuce leaves and serve.",
                    OrdinalNumber = 3
                }
            ]
        },
        new Recipe {
            ...
            Description = "A refreshing twist on the classic Caesar salad using crisp lettuce and a tangy dressing.",
            ImageUrl = "https://apleasantlittlekitchen.com/wp-content/uploads/2021/02/Herbed-Butter-Lettuce-Salad-1-of-1-scaled.jpg",
            Serves = 2,
            CookTime = "10m",
            Ingredients = [
            ...
            Steps = [
                new Step {
                    Content = "Toss chopped lettuce with Caesar dressing.",
                    OrdinalNumber = 1
                },
                new Step {
                    Content = "Top with grated Parmesan cheese and croutons.",
                    OrdinalNumber = 2
                },
                new Step {
                    Content = "Season lightly with salt and pepper.",
                    OrdinalNumber = 3
                }
            ]
        },
        ...
        // RecipeDataDuc
        new Recipe{
            Id = Guid.Parse("29d01830-e41e-4191-baeb-6917faef08ae"),
