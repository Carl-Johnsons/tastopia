  ...
  return (
    <Menubar className="relative border-none bg-transparent shadow-none">
      <MenubarMenu>
        ...
        <MenubarContent className="dark:border-dark-400 dark:bg-dark-300 absolute -right-12 mt-3 min-w-[120px] rounded border bg-white py-2">
          {themes.map((theme) => {
            return (
              <MenubarItem
                key={theme.value}
                ...
                className="hover:bg-light-800 dark:focus:bg-dark-400 flex cursor-pointer  items-center gap-4 px-2.5 py-2"
              >
