...
import styles from "./PagoToggle.style";
...
const PagoToggle = ({ title, handleToggle, icon }: PagoToggleProps) => {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {checked ? t("PagoToggle.on") : t("PagoToggle.off")}
                  {/* {checked ? "ON" : "OFF"} */}
                </Text>
              </Animated.View>
            </View>
